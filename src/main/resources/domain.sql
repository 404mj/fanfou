...
(
  ...
  `kind`       tinyint     default null comment '食物的种类:0-水果;1-凉菜;2-热菜;3-面点;4-汤粥;5-现场制作;',
...
values ('红烧排骨', 2, 1, 1, '2019-09-30', 1, 0, 0, 0),
       ('馒头', 3, 0, 1, '2019-09-30', 1, 0, 0, 0),
       ('老厨白菜', 2, 1, 1, '2019-09-30', 1, 0, 0, 0),
       ('小米粥', 4, 0, 2, '2019-09-30', 1, 0, 0, 0);
insert into food_item (food_desc, kind, recommend, period, food_time, food_week, up, down, food_belng)
values ('豆腐脑', 4, 1, 0, '2019-09-30', 1, 0, 0, 0),
       ('煎饼果子', 5, 0, 0, '2019-09-30', 1, 0, 0, 0),
       ('西葫芦水饺', 5, 0, 2, '2019-09-30', 1, 0, 0, 0),
       ('火龙果', 0, 0, 2, '2019-09-30', 1, 0, 0, 0);
